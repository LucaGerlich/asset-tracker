...
const DEPRECIATION_METHODS = [
  ...
  },
  {
    ...
    description: "More depreciation in early years",
  },
  {
    id: "sum_of_years",
    name: "Sum of Years Digits",
    description: "Accelerated based on remaining life",
  },
];
                ...
                <TableRow>
                  <TableCell colSpan={5} className="py-8 text-center">
                    <p className="text-muted-foreground">
                      No depreciation settings configured. Add asset categories
                      first.
                    </p>
                  </TableCell>
                </TableRow>
        ...
        <CardContent className="space-y-4">
          <div>
            ...
            <p className="text-muted-foreground text-sm">
              The most common method. Depreciation is spread evenly across the
              useful life. Formula: (Cost - Salvage Value) / Useful Life Years
            </p>
          </div>
          <div>
            <h4 className="font-medium">Double Declining Balance</h4>
            <p className="text-muted-foreground text-sm">
              Accelerated method that depreciates more in early years. Good for
              assets that lose value quickly. Rate is double the straight-line
              rate applied to remaining book value.
            </p>
          </div>
          <div>
            <h4 className="font-medium">Sum of Years Digits</h4>
            <p className="text-muted-foreground text-sm">
              Another accelerated method. Depreciation is based on a declining
              fraction where the numerator is the remaining useful life and
              denominator is the sum of all years.
            </p>
          </div>
        </CardContent>
      </Card>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    salvagePercent: parseFloat(e.target.value) || 0,
                  })
                }
              />
              <p className="text-muted-foreground text-sm">
                Percentage of original value at end of useful life (typically
                5-15%)
              </p>
            </div>
          </div>
