...
export const metadata: Metadata = {
  title: "Terms of Service - Asset Tracker",
  description:
    "Terms of service for using the Asset Tracker platform.",
};
          ...
          <div className="mt-12 space-y-10">
            ...
            <section>
              ...
              <div className="mt-4 space-y-3 text-sm leading-relaxed text-muted-foreground">
                <p>
                  By accessing and using Asset Tracker (&quot;the Service&quot;), you
                  agree to be bound by these Terms of Service (&quot;Terms&quot;). If
                  you do not agree with any part of these Terms, you may not use
                  the Service.
                </p>
                <p>
                  The Service is provided by Asset Tracker, Inc. (&quot;we&quot;,
                  &quot;us&quot;, or &quot;our&quot;). We reserve the right to modify these Terms
                  at any time. Continued use of the Service following any
            ...
            <section>
              ...
              <div className="mt-4 space-y-3 text-sm leading-relaxed text-muted-foreground">
                <p>
                  ...
                  process through the Service (&quot;Your Data&quot;). We do not claim
                  ownership of Your Data and will not use it for any purpose
                  other than to provide and improve the Service.
                </p>
                <p>
                ...
                <p>
                  ...
                  we take reasonable measures to protect Your Data, we are not
            ...
            <section>
              ...
              <div className="mt-4 space-y-3 text-sm leading-relaxed text-muted-foreground">
                ...
                <p>
                  ...
                  of these Terms shall not be considered a waiver of those
                  rights.
                </p>
              </div>
            </section>
