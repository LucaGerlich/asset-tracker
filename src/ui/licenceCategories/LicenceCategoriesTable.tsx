...
export default function LicenceCategoriesTable({ items }) {
  ...
  const handleDelete = async (id: string) => {
    ...
    try {
      ...
      console.error("Failed to delete licence category", err);
    ...
    <div className="w-full space-y-4">
      <div className="flex flex-col gap-4">
        <div className="flex items-center justify-between">
          <h1 className="text-2xl font-semibold">Licence Categories</h1>
        </div>
        <div className="flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
          <div className="relative w-full lg:max-w-md">
            ...
            <Input
              className="pl-9"
              placeholder="Search licence categories"
              value={searchValue}
              onChange={(e) => {
          ...
          <div className="flex flex-wrap gap-3">
            <Button asChild>
              <Link href="/licenceCategories/create">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3">
          <span className="text-muted-foreground text-sm">
            Showing {paginatedItems.length} of {filteredItems.length} licence
            categories
          </span>
        </div>
      </div>
