...
const FRESHDESK_API_BASE_TEMPLATE = (domain: string) =>
...
export class FreshdeskClient {
  ...
  async getTickets(
    ...
    if (filters?.updated_since)
      params.append("updated_since", filters.updated_since);
  ...
  async getTicketConversations(
    ticketId: number,
  ): Promise<FreshdeskApiResult<unknown[]>> {
 ...
 */
export function createFreshdeskClient(
